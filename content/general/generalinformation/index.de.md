...
description: Übergreifende Informationen zu FIP, FIP Ausweis (Internationale
  Ermäßigungskarte für Eisenbahnpersonal) sowie der Nutzung Internationaler
  Fahrvergünstigungen wie FIP 50 und FIP Freifahrtscheinen
  (Auslandsfreifahrten).
toc: true
aliases:
  - /generalinformation/
...
{{% highlight tip %}}
In der Praxis ist die 2-Tagesregelung nicht immer bekannt. Im Zug kann [diese übersetzte Erläuterungstabelle](/en//general/generalinformation/2-day-rule.pdf) ausgedruckt helfen.
{{% /highlight %}}

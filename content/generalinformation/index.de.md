...
Abhängig der Vereinbarung zwischen den FIP-Mitgliedern können auch Familienangehörige (Kinder, Lebensparnter) FIP-Vergünstigungen nutzen. Dies wird immer auf den jeweiligen [Betreiberseiten]({{< ref "operator" >}}) mit genannt. Auch Ermäßigungen für Kinder sind hier zu finden.
...
{{% expander "Welche Regelungen gibt es bei FIP-Coupons?" info "faq" %}}
...
{{% expander "Wo kann ich FIP Coupons bestellen?" info "faq" %}}
...
{{% expander "Wie viele Felder kann ich bei FIP-Coupons beantragen?" info "faq" %}}
...
{{% expander "Was bedeutet ein Feld auf dem FIP-Coupon?" info "faq" %}}
...
{{% expander "Wie lange ist ein FIP-Coupon gültig?" info "faq" %}}
...
{{% expander "Gibt es Ausnahmen bei der Nutzung von FIP-Coupons?" info "faq" %}}

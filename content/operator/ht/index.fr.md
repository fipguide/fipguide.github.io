...
- La réservation est obligatoire dans les trains grandes lignes.
...
- **Class B** : Utilisable avec une Carte FIP ou un Coupon FIP de 2ᵉ classe. La plupart des trains de Hellenic Train ne disposent que de la Class B.
- **Class A** : Utilisable avec une Carte FIP ou un Coupon FIP de 1ère classe. Cette classe existe sur certains trains IC. Des rafraîchissements, café, eau et en-cas sont offerts gratuitement.[^4]

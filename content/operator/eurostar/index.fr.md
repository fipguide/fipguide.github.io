...
Valable pour les correspondances à Paris, Bruxelles, Cologne, Munich, Bâle et Zurich.
{{% /highlight %}}
...
🛂 **Qu'est-ce que London International CIV ?**

Pour garantir une correspondance protégée entre Eurostar et un train britannique (ou inversement), il est possible de réserver un billet à destination ou provenance de **_London International CIV_**.

Deux types :
- **Advance** : à l’avance, pour train spécifique, prix variable.
- **Euro Open / Saver** : valable toute la journée.

...
Pour les trajets transfrontaliers, un Billet FIP 50 ininterrompu ou les Coupons FIP des deux exploitants dans les deux pays doivent être disponibles. Pour les trajets avec différents exploitants en Pologne, un Billet FIP 50 ininterrompu ou les Coupons FIP des deux exploitants doivent être disponibles.
...
| {{< icon "child_care" >}} 4–25 ans       | Réduction de 20 % sur le tarif normal[^1] |
...
Les Billets FIP ne sont pas valides dans les trains spéciaux exploités par KŚ.

### Utilisation des Coupons FIP de PKP sur les lignes KŚ

Sur les lignes suivantes de KŚ, tant les Billets FIP de KŚ que ceux de PKP sont valides :

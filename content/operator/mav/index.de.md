...
- FIP Freifahrtscheine und FIP 50 Tickets werden bei MÁV anerkannt.
- FIP gilt nicht in MÁV-Bussen, außer im Schienenersatzverkehr.
...
Die Schmalspurbahn von Balatonfenyves nach Somogyszentpál und Csisztafürdő am Südufer des Plattensees (Balaton) ist die letzte von der MÁV betriebene Schmalspurbahn. Sie ist mit FIP nutzbar.[^1]
...
| Alter       | Ermäßigung                         |
| ----------- | ---------------------------------- |
| 0–13 Jahre  | Kostenlos[^2]                      |
| ab 14 Jahre | Regulärer FIP-Erwachsenentarif[^2] |
...
Eine Fahrtunterbrechung ist bei MÁV ohne zusätzliche Formalitäten möglich.[^1]

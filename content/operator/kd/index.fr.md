...
Sur son site Web, KD propose une [carte d’ensemble des lignes](https://kolejedolnoslaskie.pl/wp-content/uploads/2025/12/Schemat-UMWD-2025-2026-1.1.pdf).

## Résumé

- KD accepte le Coupon FIP et le Billet FIP 50.
- Seule la 2ème classe est disponible dans les trains KD et aucune réservation n’est possible.
- Certains trains spéciaux sont exclus du FIP.
...
Pour les voyages transfrontaliers, il faut soit un Billet FIP 50 continu, soit des Coupons FIP des deux opérateurs dans les deux pays. Exception entre Zgorzelec et Görlitz, aucun billet supplémentaire n’est requis sur ce court tronçon (voir [Trains entre Zgorzelec et Görlitz](#trains-entre-zgorzelec-et-görlitz)). Pour les trajets impliquant plusieurs opérateurs en Pologne, il est nécessaire de disposer soit d’un Billet FIP 50 continu, soit de Coupons FIP de chaque opérateur concerné.
...
| à partir de 12 ans | Tarif normal[^1]     |
...
Quelques trains "KD Specjal" circulent en dehors de la grille régulière. Le FIP n’est pas valable à bord.

En saison estivale, KD propose aussi des trains spéciaux "KD Premium", reliant Wrocław à Świnoujście sur la Baltique, au-delà de la Basse-Silésie. Le FIP n’est pas accepté sur ces trains, qui sont annoncés comme tels dans les moteurs de recherche.

### Trains entre Zgorzelec et Görlitz

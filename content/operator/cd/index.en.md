...
| {{< icon "child_care" >}} 6–17 years | 50% discount on the regular price in 2nd class[^4] |
| {{< icon "person" >}} from 18 years  | Regular price[^3]                                  |

{{% highlight tip %}}
The discount for children aged 6 to 17 can be cheaper than the FIP 50 fare on trains with a FIP surcharge.
{{% /highlight %}}
...
[View complete list 2026 – long-distance trains](dialog:commercial-supplement-long-distance)
...
**Other long-distance lines - R17, Ex7, R31**

| Train number | Line | From                  | To                    |
| ------------ | ---- | --------------------- | --------------------- |
...
The list is also provided by ČD: [ČD commercial trains 2026 (page 13)](https://www.fvc.cz/prilohy/prolongace-2026-vcetne-priloh.pdf#page=13)
{{% /dialog %}}
...
[View complete list 2026 – regional trains](dialog:commercial-supplement-short-distance)
...
Meanings of route numbers can be found in the [ČD route network](https://www.spravazeleznic.cz/documents/50004227/184412001/mapa+KJ%C5%98.pdf/842ee5f5-0d77-4f0b-b601-927d63aab022).
{{% /dialog %}}
...
[View complete list 2026 – border crossings](dialog:commercial-supplement-border-crossings)

{{% dialog
    id="commercial-supplement-border-crossings"
    title="ČD commercial services 2026 – border crossings"
%}}

| Type | Train number(s)            | Route section              |
| ---- | -------------------------- | -------------------------- |
...
The list is also provided by ČD: [ČD commercial trains 2026 (page 15)](https://www.fvc.cz/prilohy/prolongace-2026-vcetne-priloh.pdf)
...
[View complete list South Moravia](dialog:no-fip-south-moravia)

{{% dialog
    id="no-fip-south-moravia"
    title="ČD services without FIP 2026 – South Moravia (Brno)"
%}}

| Line | Route    | Route section and trains                                                             |
| ---- | -------- | ------------------------------------------------------------------------------------ |
...
| S2   | 260      | Letovice – Brno hl. n. – Holubice — in `Sp` and `Os`                                 |
...
FIP benefits are not valid only in the indicated section.
...
[View complete list Pilsen](dialog:no-fip-pilsen)

{{% dialog
    id="no-fip-pilsen"
    title="ČD services without FIP 2026 – Pilsen (Plzeňský kraj)"
%}}

### Line P2

| Type | Train | From         | Departure | To           | Arrival |
| ---- | ----- | ------------ | --------: | ------------ | ------: |
...
The list is also provided by ČD: [ČD commercial trains 2026 (page 18)](https://www.fvc.cz/prilohy/prolongace-2026-vcetne-priloh.pdf#page=18)
{{% /dialog %}}

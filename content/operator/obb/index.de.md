...
**Reservierung möglich:** ja \
**Reservierungspflicht:** Nur Richtung Italien ab der italienischen Grenze (Brenner)
{{% /expander %}}

{{% expander "NightJet (EN) / EuroNight (EN) ⚠️" traincategory "long-distance" %}}
**Beschreibung:** \
...
Sitzplatzreservierungsanzeigen in ÖBB-Zügen können mit „ggf. reserviert“ gekennzeichnet sein. Das bedeutet, dass der Platz im Buchungssystem für kurzfristige Reservierungen freigehalten wird. Offiziell wird empfohlen, diese Plätze nicht zu besetzen. Falls Sie dennoch dort sitzen, müssen Sie den Platz räumen, wenn ein Fahrgast mit gültiger Reservierung erscheint.

...
- FIP 50 gilt bei allen [Bahn- und Busbetreibern](#zug--und-busbetreiber) sowie [Betreibern von Schiffen](#betreiber-von-schiffen), die unter SP zusammengefasst sind
- FIP Freifahrtscheine gelten bei den meisten Betreibern, jedoch gibt es hier Ausnahmen bei einzelnen touristischen Verkehren
- Reservierungen sind grundsätzlich nicht nötig, bei einzelnen eher touristischen Verkehren bestehen Ausnahmen
...
{{% expander "Frauenfeld–Wild-Bahn (FW)" traincategory "category" %}}
**Beschreibung:** \
...
- BLM: Grütschalp nach Murren (Zug)
...
**Reservierung möglich:** Teilweise \
**Reservierungspflicht:** ⚠️ Ja, für den Glacier Express
{{% /expander %}}
...
Daneben ist sie auch das betreibende Eisenbahnverkehrsunternehmen auf den Strecken der Transports Montreux–Vevey–Riviera (MVR), wodurch weitere Schmalspurstrecken sowie Standseilbahnen in den Betrieb der MOB integriert sind.
...
- Vevey – Chardonne – Mt-Pelèrin (Standseilbahn)
- Montreux – Glion – Rochers-de-Naye
- Territet – Glion (Standseilbahn)
- Les Avants – Sonloup (Standseilbahn)

**Reservierung möglich:** Teilweise \
**Reservierungspflicht:** Nein (Mitfahrt allerdings auf den Strecken mit Reservierungsmöglichkeit nicht garantiert)
{{% /expander %}}
...
{{% expander "Rhätische Bahn (RhB) ⚠️" traincategory "category" %}}
**Beschreibung:** \
...
**Reservierung möglich:** Teilweise \
**Reservierungspflicht:** ⚠️ Ja, auf dem Bernina und Glacier Express
{{% /expander %}}
...
FIP-Vergünstigungen sind zwischen Martigny und Le Châtelard-Frontière auf dem Mont-Blanc-Express gültig. Zwischen Le Châtelard-Frontière und Vallorcine wird die Strecke von der SNCF betrieben, für die dann ebenfalls FIP genutzt werden kann, der Freifahrtschein der SP hat hier jedoch keine Gültigkeit (es muss ein SNCF Freifahrtschein vorliegen).
...
**Reservierung möglich:** Teilweise \
**Reservierungspflicht:** ⚠️ Ja, für die Züge nach 23 Uhr
{{% /expander %}}
...
- Bulle-Broc – Fabrique
- Fribourg/Freiburg – Neuveville – St-Pierre (Standseilbahn)
...
**Reservierung möglich:** Ja, für den Luzern-Interlaken-Express \
**Reservierungspflicht:** Nein
{{% /expander %}}
...
{{% expander "Compagnie générale de navigation (Genfersee) (CGN)" traincategory "category" %}}
**Beschreibung:** \
...
Dazu kommen noch Ticketschalter der einzelnen SP-Bahnen, die meist nur die Tickets der jeweiligen Bahn verkaufen.
...
Der Glacier Express verkehrt auf der Route St. Moritz – Chur – Andermatt – Brig – Zermatt und wird gemeinsam durch die beiden SP-Bahnen Rhätische Bahn (RhB) und Matterhorn Gotthard Bahn (MGB) betrieben. In der Sommersaison wird hier mehr als eine Verbindung am Tag, teilweise auch nur auf Teilstrecken, angeboten.

FIP Freifahrtscheine der SP und FIP 50 Tickets sind gültig in dem Zug, aber nur mit zusätzlicher kostenpflichtiger Sitzplatzreservierung. Diese kann über die [Glacier Express Website](https://glacierexpress.ch/de/price) gebucht werden und sollte möglichst einige Zeit im Voraus gemacht werden, da Züge schnell ausgebucht sein können.

Alternativ zum Glacier Express (in der Reiseauskunft als `PE` gekennzeichnet) stehen andere Verbindungen auf der Route zur Verfügung, bei denen keine Reservierungspflicht besteht.

### Bernina Express

Der Bernina Express ist neben dem Glacier Express ein weiterer bekannter Panorama-Zug in der Schweiz. Dieser verkehrt auf der Strecke zwischen Chur und Tirano in Italien und wird ausschließlich von der Rhätischen Bahn (RhB) betrieben. In der Sommersaison wird hier mehr als eine Verbindung pro Tag angeboten.

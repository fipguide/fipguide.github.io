...
- Le FIP 50 est accepté sur les routes internationales et les routes nationales (sauf en juillet et août).
- Avantages FIP sur toutes les catégories de cabines et de sièges (sauf cabines LUX).
...
{{% train-category
    id="international"
    title="Italie – Grèce (Superfast Ferries & Anek Line)"
    type="ship"
    fip_accepted=true
...
- Corfou – Ancône / Bari / Venise (uniquement en saison estivale)
- Venise – Patras / Igoumenitsa / Corfou (Venise – Corfou uniquement en saison estivale)
- Ancône – Patras / Igoumenitsa / Corfou (Ancône – Corfou uniquement en saison estivale)
- Bari – Patras / Igoumenitsa / Corfou (Bari – Corfou uniquement en saison estivale)

{{% /train-category %}}

{{% train-category
    id="national"
    title="Routes intérieures grecques (Blue Star Ferries, Hellenic Seaways & Anek Line)"
    type="ship"
    fip_accepted=true
    reservation_required=false
    reservation_possible=true
...
Attica propose différentes classes de voyage :

- Sièges Economy et de type avion
- Cabines intérieures, extérieures et lux

Les cabines LUX sont exclues de tous les avantages FIP.[^2]
...
| Âge               | Réduction                                                                                             |
| ----------------- | ----------------------------------------------------------------------------------------------------- |
| 0–3 ans           | 6,00 € par traversée, à condition de n’occuper ni lit, ni couchette, ni siège inclinable[^3]          |
| à partir de 4 ans | Tarif normal (s’applique aussi aux 0–3 ans occupant un lit, une couchette ou un siège inclinable)[^3] |

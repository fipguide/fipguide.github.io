...
Reservations for trains can be purchased on site for € 0.51. If you are using an FIP Coupon, you must present it; the coupon number will be printed on the ticket.
{{% /booking-section %}}

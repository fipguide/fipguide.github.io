...
L’État allemand et la Deutsche Bahn investissent massivement dans l’extension et la rénovation générale du réseau. D’ici 2030, les principaux corridors doivent être transformés en réseau à haute performance. De nombreuses gares sont également modernisées et transformées en gares du futur.
Parmi les axes grandes lignes les plus importants :

- Berlin – Munich via la ligne à grande vitesse par Erfurt
- Cologne – Francfort avec des ICE jusqu’à 300 km/h
- Hambourg – Stuttgart et Dortmund – Munich comme axes nord-sud
- Ruhr – Berlin via Hanovre

La flotte de trains est également renouvelée, ce qui permet d’utiliser principalement des trains modernes et confortables en grandes lignes. En trafic régional, de nombreux types de véhicules circulent, avec des niveaux de confort très variables.

En raison des nombreux chantiers, des lignes saturées et des perturbations, la ponctualité en grandes lignes est inférieure à 65 %. En trafic régional, la situation est un peu meilleure, mais il existe aussi des défis.
Entre les grandes villes, il existe des liaisons grandes lignes et régionales horaires, qui se complètent sur certains tronçons pour offrir une cadence encore plus dense.
Dans les grandes agglomérations comme Berlin, Hambourg ou Munich, la cadence est très élevée – souvent toutes les 10 à 20 minutes. Dans les régions rurales, les liaisons sont souvent rares et irrégulières.

Grâce à sa situation centrale, l’Allemagne dispose de nombreuses liaisons internationales, de jour comme de nuit.

Itinéraires particulièrement recommandés :

- Schwarzwaldbahn (Karlsruhe – Constance) : traverse 39 tunnels et offre des vues spectaculaires sur la Forêt-Noire
- Moseltalbahn (Coblence – Trèves) : trajet romantique le long de la Moselle avec vue sur les vignobles et les châteaux
- Mittelrheinbahn (Mayence – Cologne) : le long du Rhin avec vue sur la Loreley, des châteaux et des villages viticoles
- Bodenseegürtelbahn (Radolfzell – Lindau) : vue sur le lac de Constance et les Alpes
- Nationalparkbahn (Dresde – Bad Schandau) : à travers la Suisse saxonne avec vue sur les célèbres formations rocheuses
- Marschbahn (Hambourg – Sylt) : sur la digue de Hindenburg directement vers l’île de Sylt
- Ligne à grande vitesse Cologne – Francfort : à 300 km/h à travers le paysage

L’« Allianz pro Schiene » récompense chaque année les plus belles gares du pays. Un [aperçu des gares primées](https://www.allianz-pro-schiene.de/wettbewerbe/bahnhof-des-jahres/) est disponible sur le site de l’association.
...
En trafic régional, il est aussi possible d’entrer par Tønder. DSB exploite le tronçon danois de la ligne sous le nom de « DSB Vores Tog », ce qui permet d'utiliser les FIP. Pour le tronçon allemand, un billet ordinaire ou le Deutschlandticket est requis, car les trains y sont exploités par NEG. Il est aussi possible de rejoindre l’Allemagne par ferry à Puttgarden ou Warnemünde ; toutefois, dans ce cas, les tarifs FIP ne s'appliquent pas et vous devrez payer le plein tarif.
...
Les autres points frontières ne sont desservis qu’en régional. Le plus simple est Bayerisch Eisenstein, qui est à la fois point frontière et gare frontière. Côté tchèque, un Coupon FIP / FIP 50 ČD suffit pour continuer en Allemagne.
...
Entre l’Autriche et l’Allemagne, il existe, outre diverses liaisons régionales, deux grandes lignes :

- Une ligne `ICE` Francfort / Cologne (ou certains trains depuis Berlin) – Nuremberg – Passau – Linz – Vienne.
- Des `ICE`, `RJ` et `IC` reliant diverses villes autrichiennes à Munich via Salzbourg.
...
La Suisse dispose de plusieurs liaisons transfrontalières avec l’Allemagne.

- La plus utilisée est celle reliant Bâle au réseau allemand. Des `ICE` circulent toutes les 1 à 2 heures entre Bâle et Mannheim, puis vers Francfort (Main), Cassel, Hambourg ou Francfort (Main), Cologne, Dortmund, Hanovre. Certains trains partent de Zurich, Interlaken, Berne ou Coire.
- Des `EC` et `ECE` circulent aussi sur cette ligne vers Mannheim.
- Des trains régionaux relient Bâle Bad Bf à Singen (Hohentwiel), Lauchringen, Fribourg et Friedrichshafen.

À noter : les Coupons FIP DB sont valables dès la gare de Bâle Bad Bf (gare frontière officielle DB/SBB).

Sur la ligne Bâle SBB – Zell (Wiesental), la S-Bahn 6 circule, mais en Allemagne elle est exploitée par SBB GmbH et n’est accessible avec des Coupons FIP SBB que sur la section suisse entre Bâle SBB et Bâle Bad Bf.

{{% highlight tip %}}
Pour entrer en Allemagne sans billet SBB (par ex. Coupon FIP ou FIP 50), la S-Bahn 6 entre Bâle SBB et Bâle Badischer Bahnhof est accessible avec le Deutschlandticket. [^1]
{{% /highlight %}}
...
Depuis le Luxembourg, des trains régionaux transfrontaliers circulent vers Coblence / Wittlich / Trèves. Pour la section luxembourgeoise en 2e classe, aucun billet n’est requis, le trafic régional étant gratuit. En Allemagne, un Coupon FIP (ou FIP 50) DB est nécessaire.
Un train direct CFL Luxembourg – Düsseldorf circule une fois par jour. Entre Düsseldorf et Coblence, il est exploité comme train grandes lignes `IC`.

Il existe aussi un bus CFL Luxembourg – Sarrebruck, sans réduction FIP.
...
La DB Regio circule sur la section allemande. Avec un billet supplémentaire pour la section NS ou un billet FIP 50 valable sur tout le trajet, tout est couvert.

Sur les `RE` Venlo – Hamm et Arnhem – Düsseldorf, le Deutschlandticket est valable sur tout le trajet. Si vous possédez ce billet, vous pouvez donc aussi entrer en Allemagne.

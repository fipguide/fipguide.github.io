...
params:
  ...
  operators_without_fip:
    - name: CFC (Chemins de fer de la Corse / Eisenbahnen auf Korsika)
      query:
    - name: '[Frecciarossa (Trenitalia)](/operator/fs/#internationale-frecciarossa-züge-nach-paris "Frecciarossa (Trenitalia)")'
      query:

...
Romania can be travelled quite well with FIP overall. On the main routes, the Romanian state railway [CFR Călători](/operator/cfr "CFR") operates most services, and both FIP Coupons and FIP 50 Tickets are accepted. It should be noted that on some routes, other operators also run parallel services that cannot be used with FIP.
